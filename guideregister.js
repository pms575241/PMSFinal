...
document.getElementById('guideregisterForm').addEventListener('submit', submitForm);
...
function submitForm(e){
  ...
  var keypassword = getInputVal('keypassword');
  var fullname = getInputVal('fullname');
  var department = getInputVal('department');
  var email = getInputVal('email');
  var mbno = getInputVal('mbno'); 

  writeUserData(password,keypassword, fullname,department, email, mbno);
...
function writeUserData(password, keypassword, fullname,department, email, mbno){
...
function signUpWithEmailPassword() 
{
    ...
    {
      // Signed in 
      document.getElementById('guideregisterForm').reset();
